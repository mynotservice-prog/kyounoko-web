...
const NAME_STOPWORDS = new Set(
  [
    ...
    // 2026-09-01 追記: 駅ビル・商業施設の「ブランド単体名」は都市をまたいで別建物を指すので
    // 施設エンティティにしない（アトレ上野とアトレ大井町の営業時間が食い違いに見えた実測）。
    // 「アトレ大井町」のようなフルネームは引き続き語彙に入る。
    // 「アトレ本館」は facilityKey の (本館|新館)$ 除去で「アトレ」に正規化されてここに当たる。
    'アトレ', 'ルミネ', 'エキュート', 'パルコ', 'マルイ', '丸井', 'イオン', 'イオンモール',
    'ららぽーと', '伊勢丹', '高島屋', '三越', '東急', '西武', '東武', 'ニュウマン',
