/**
 * かつや: アークランドサービスの公式店舗検索（shop.arclandservice.co.jp/ae-shop、NAVITIME製）。読み方は _navitime.mjs 参照。
 * 業態カテゴリ「かつや」(01) だけ数える。「施設情報」の条件のうち設備に当たるのは「駐車場あり」(d28) のみ
...
export async function crawl() {
  return crawlNavitime({
    ...
    method: '公式店舗検索（shop.arclandservice.co.jp/ae-shop）の一覧APIでカテゴリ「かつや」の全店舗を列挙し、「施設情報」の条件「駐車場あり」で絞り込んだ結果に含まれる店舗を店舗ごとに集計（国内店のみ）',
