...
const TOPICS = [
  ...
  { name: 'ナッツ・ピーナッツ', test: (s) => /nuts|peanut|nattsu|kurumi|almond|cashew/.test(s), imgs: ['/img/scenes/nuts-ng-01.webp'] },
  ...
  { name: 'おむつ', test: (s) => /omutsu|moony|goon|pampers|merries|oshiri-fuki/.test(s), imgs: ['/img/scenes/omutsu-hikaku-01.webp', '/img/scenes/nursingroom-02.webp', ...pick('nursery', 1, 3)] },
