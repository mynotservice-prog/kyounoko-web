...
const TOPICS = [
  ...
  { name: '麺・ラーメン', test: (s) => /ramen|men-rui|pasta|udon|soba|noodle/.test(s), imgs: [...pick('chuka', 2, 1), ...pick('meal', 19, 22)] },
  ...
  { name: 'おやつ・甘いもの', test: (s) => /aisu|ice|chocolate|okashi|oyatsu|sweets|ame|gum|juice|cola|donut|cake|purin/.test(s), imgs: [...pick('meal', 9, 13, 21, 34), ...pick('cooking', 3)] },
  ...
  { name: '学習・教材・習い事', test: (s) => /kumon|gakken|kyouzai|benesse|zkai|popi|challenge|smile-zemi|dwe|eigo|chiiku|tsuushin|naraigoto|programming|shichida|hiragana|moji|study|gakushuu/.test(s), imgs: [...S('lesson', 10), ...pick('book', 2, 5)] },
  ...
  { name: 'おむつ・ベビー用品', test: (s) => /omutsu|moony|goon|pampers|merries|oshiri-fuki|dakkohimo|babycar|stroller|chairseat|car-seat|baby-goods|rucksack/.test(s), imgs: [...S('stroller', 7), ...S('strollerok', 3), '/img/scenes/nursingroom-02.webp'] },
