...
const BANNED_PHRASES = [
  ...
  '独自集計',
  '独自調査',
  // ⚠ '編集長' は禁止語から外した（2026-07-28）。
  //   理由: これは著者クレジット（/authors/nagamy「ながみー（編集長／4歳娘・2歳息子の父）」）
  //   であり、かつ **lib/chain-reports.ts に記録した実店舗確認の正しい帰属表記**でもある。
  //   「編集長が◯◯店で確認（YYYY年M月）」は捏造ではなく、公式サイトに記載が無い項目で
  //   唯一書ける一次情報＝差別化の核。ここを禁止すると本物の実体験まで書けなくなる。
  //   本当に防ぎたい「未検証の体験主張」は scripts/check-fabricated-claims.mjs が
  //   （公表年齢を超える記述・自称調査・未検証の「公式が〜」として）押さえている。
  '我が家',
  'わが家',
  '筆者',
  '行ってきました',
