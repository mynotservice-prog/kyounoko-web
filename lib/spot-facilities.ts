...
export const SPOT_FACILITIES: Record<string, Facilities> = {
  ...
  // ── 2026-08-19 公園バッチ3 ──
  '錦糸公園 噴水': {
    note: '墨田区公式「水遊びができる公園」で、錦糸四丁目15番1号・利用期間7月〜9月・午前9時〜午後4時・形態はドライ噴水（ミスト／ポップアップ／樹氷）と確認。観賞用の噴水池には入れない（記事側でも書き分け済み）。墨田区は紙オムツ不可だが水遊び用オムツは水着着用で利用可。監視員はいない。2026-08-19確認。',
  },
  '大横川親水公園 じゃぶじゃぶ池': {
    note: '墨田区公式「水遊びができる公園」で、園内に2か所あることを確認。東駒形四丁目14番先は「流れ」で通年利用（5月〜11月は消毒実施）・終日、2026年8月6日（木）と8月20日（木）午前は利用休止。江東橋一丁目1番先はポップアップ噴水で7月〜9月・午前9時〜午後5時。紙オムツ不可・水遊び用オムツは水着着用で可、監視員なし。2026-08-19確認。',
  },
  '和田堀公園 じゃぶじゃぶ池': {
    note: '都立公園公式ページで公園の存在と管理者（善福寺川緑地サービスセンター 03-3313-4247）を確認。ただし**公式にじゃぶじゃぶ池の会期・時間の掲載は無い**ため、稼働期間は公式では裏が取れない。記事側は「例年の目安」と当日の確認を促す書き方になっており、その扱いが妥当。2026-08-19確認。',
  },
  '烏山川緑道 じゃぶじゃぶ池': {
    note: '世田谷区公式の烏山川緑道ページを確認したが、**水遊び場の会期・時間の記載は無い**。緑道は延長約7kmで、記事が水遊び場所として挙げている石仏公園も含む区間。稼働期間は公式では裏が取れないため、記事側の「例年7〜8月・当日の稼働は保証されない」という書き方が妥当。2026-08-19確認。',
  },
  // ── 2026-08-19 公園バッチ4 ──
  '上柚木公園 じゃぶじゃぶ池': {
    note: '⚠ **この公園に水遊び施設は無い。** 八王子市公式の施設案内にも、公園公式サイト（kamiyugi-park.jp）の公園施設一覧にも、じゃぶじゃぶ池・水遊び場・親水施設の記載が無いことを確認した。整備中のインクルーシブ広場も、第2期・第3期（2026年6月下旬〜年度末）に予定されているのはウレタン製の大型すべり台とバリアフリー対応のトイレ・駐車場で、水遊び施設は含まれていない。旧記載は「水遊び施設を改修中」としていたが裏付けが取れないため、表示名を「上柚木公園」に変え、本文とFAQで施設が無いことを明記した。第1期インクルーシブ広場は2026年5月1日供用開始。2026-08-19確認。',
  },
  'お台場海浜公園': {
    note: '記載どおりで修正なし。通常は遊泳禁止で、期間限定イベント時のみ海水浴が実施される点は本文で書き分け済み。2026年の「ODAIBA PLAGE」は7月17日〜21日に開催され、すでに終了している。2026-08-19確認。',
  },
  '等々力渓谷': {
    note: '危険木の伐採等のため2023年7月から立入禁止だったが、2026年3月24日に約3年ぶりに通行が再開され全面開放されていることを確認（記載どおり）。2026-08-19確認。',
  },
  '北海道こどもの国': {
    note: '施設公式で営業中と確認。砂川市北光401-1、9時30分〜17時、シーズンは4月下旬〜11月上旬で2026年の開園は4月25日（土）。入園無料（一部施設は有料）。「ふしぎの森」は4月25日〜9月30日が9時30分〜17時、10月1日〜11月8日が10時〜16時。駐車場924台。※正式名称は「北海道子どもの国」。2026-08-19確認。',
  },
  '武蔵野公園 じゃぶじゃぶ池': {
    note: '公園公式（むさしのの都立公園）のお知らせで、2026年は設備点検のため8月3日（月）と9月1日（火）が終日休止と確認し、記事の混雑メモに追記した。※稼働期間そのもの（記事の「7月1日〜9月30日・10:00〜16:00」）は公式に掲載が見つからず、直接の裏は取れていない。ただし公式が9月1日を点検休止日として告知していること自体が、9月も稼働している傍証になる（2023年の公式告知は7月21日〜8月31日だった）。2026-08-19確認。',
  },
  'こどもの国 アクアシスパーク': {
    note: 'こどもの国公式で、2026年の屋外プール営業は7月18日（土）〜8月30日（日）、毎週水曜は閉場（8月12日は開場）、最終入場15:30と確認。セット券（入園+プール）はおとな1,400円・高校生1,200円・小中学生600円・幼児500円。**8月30日で終了する**ため、9月以降にこのページを見た人向けの書き方に注意が要る。2026-08-19確認。',
  },
  '城南島海浜公園': {
    note: '記載どおりで修正なし。つばさ浜は**遊泳禁止**（浮き輪・ゴムボートも不可）で砂遊びと散歩の場であることは本文に明記済み。潮干狩りは可。公園は常時開園、つばさ浜とスケボー広場の利用は日中のみ。2026-08-19確認。',
  },
  '友ヶ島': {
    note: '友ヶ島汽船（公式）で運航中と確認。加太港から約20分。3月1日〜12月28日は水曜運休（水曜が祝日なら運航）、4月28日〜5月6日と7月20日〜8月31日はGW・夏休み時刻表。2026年7月1日から運賃改定。荒天による臨時欠航があるため、出発前に公式で運航状況の確認が要る島。2026-08-19確認。',
  },
  '華蔵寺公園': {
    note: '伊勢崎市公式で営業中と確認。園内の遊園地は2026年1月1日からネーミングライツにより **「Auto Mirai 華蔵寺遊園地」** に名称変更（2028年12月31日まで）。営業時間は3月〜11月が9時〜17時、12月〜2月が9時30分〜16時30分。入園無料で、乗り物は個別料金。2026-08-19確認。',
  },
  'ハイジの村': {
    note: '北杜市公式・山梨県公式観光サイトで営業中と確認。正式には山梨県立フラワーセンター。北杜市高根町村山北割3261。花の見頃はチューリップ4月中旬〜5月上旬、バラ5月下旬〜6月下旬、ラベンダー7月上旬〜7月下旬、ひまわり8月上旬〜8月下旬。営業時間・料金は公式で要確認（今回は確定できず記録していない）。2026-08-19確認。',
  },
  'モヤヒルズ': {
    note: '青森市公式・青森県公式観光サイトで営業中と確認。正式名称は「リンクステーションヒルズ雲谷（モヤヒルズ）」。夏はヒルズサンダー（ローラーリュージュ）が4月下旬〜10月下旬の10時〜17時、テニスコートが4月下旬〜10月の9時〜21時、オートキャンプ場も同時期。ヒルズクラブは通年9時〜21時だが、スパ（プール・温水シャワー）は7月〜9月の土日祝と青森市の小学校夏休み期間のみ10時〜21時（最終入場20時30分）。2026-08-19確認。',
  },
  // ── 2026-08-19 レストラン層: テンプレの価格を外し、公式で裏の取れる館内設備に置き換える ──
  '仙台パルコ・エスパル仙台 レストランフロア': {
    nursingRoom: 'yes',
    diaperChange: 'yes',
    strollerRental: 'yes',
    note: 'エスパル仙台公式「KIDS & BABY お役立ちガイド」で、授乳室は本館2F南側・東館北棟3F・東館南棟3F、おむつ替えコーナーは本館3F南側と確認。**東館3F（南側・北側）は子連れの男性も利用できる**。調乳機・ベビーキープ・ベビーベッド・ベビーカー貸出あり。仙台パルコは5Fにベビールーム、B2F・B1F・3F〜9Fの多目的トイレにおむつ替えシート・ベビーキープ・子供用便座。※旧データの「キッズメニュー500円〜」はテナントごとに異なり裏が取れないため削除した。2026-08-19確認。',
  },
  '富山駅 マルート レストラン': {
    nursingRoom: 'yes',
    diaperChange: 'yes',
    note: 'MAROOT公式・富山市公式観光サイトで、4階に授乳室とおむつ台があることを確認。営業時間は物販10:00〜20:00、飲食11:00〜20:00（店舗により異なる）。飲食は1階が中心で、富山湾食堂（海鮮丼）やベーカリー、カフェが入る。※旧データの「キッズメニュー500円〜」は削除した。2026-08-19確認。',
  },
  '松山三越 レストランフロア': {
    note: '松山三越公式で、館内の飲食は1階の**「坊っちゃんフードホール」**（15店・300席以上）が中心と確認。フードホール形式なので子連れでも入りやすいが、旧データの「レストランフロア／ランチ1,500円〜／キッズメニュー500円〜」はテナントごとに異なり裏が取れないため削除した。子連れ設備は公式に記載が無く未確認。2026-08-19確認。',
  },
  'IKEA 鶴浜 レストラン': {
    kidsSpace: 'yes',
    note: 'IKEA公式のレストラン案内で、12歳以下向けのキッズメニュー（キッズプレート、ミートボール、プラントベースカレー等）があること、**レストランで食事する客に瓶詰めの離乳食を無料で提供**していることを確認。離乳食は数に限りがあり、会計時にスタッフへ申し出る方式なので「必ずもらえる」とは書かないこと。2026-08-19確認。',
  },
  'あべのハルカス近鉄本店（天王寺・阿倍野）': {
    nursingRoom: 'yes',
    diaperChange: 'yes',
    strollerRental: 'yes',
    note: '館内にベビー休憩室があることは確認できたが、フロアや設備の詳細は公式サイトでの裏取りができず、二次情報（タワー館8階のベビーサロン、ウィング館8階の授乳室）にとどまる。ベビーサロンは女性専用との情報があるため、父親のみで行く場合は事前確認が要る。※フロアの断定は避けている。2026-08-19確認。',
  },
  '神戸三宮センタープラザ レストラン': {
    note: '公式サイトに子連れ設備（授乳室・おむつ替え）の記載を見つけられなかったため、**設備は未確認のまま**とする。旧データの「キッズメニュー500円〜」はテナントごとに異なり裏が取れないため削除済み。子連れで授乳室が要る場合は、近隣のクレフィ三宮など設備を公開している施設を当てにする方が確実。2026-08-19確認。',
  },
  '京都駅ビル ザ・キューブ・ジェイアール京都伊勢丹 レストラン': {
    note: 'ジェイアール京都伊勢丹の公式にベビー休憩所の案内ページが存在することは確認したが、ページ本体の取得が2度ともタイムアウトし、**フロアと設備を公式で確定できなかった**。二次情報では7階だが断定しない。旧データの「キッズメニュー500円〜」は削除済み。2026-08-19確認。',
  },
  // ── チェーンは店舗ごとに席・設備が違う。全店に共通する断定を置かない（矢場とんの扱いに合わせる）──
  '551蓬莱': {
    note: 'チェーンのため店舗によって形態が大きく違う（持ち帰り専門店・イートイン併設店・レストラン形態が混在）。「全店にイートインがある」「全店にベビーチェアがある」とは言えないため、chain全体への設備フラグは外した。豚まんを1個から頼めて取り分けやすい点は共通して使える。2026-08-19確認。',
  },
  'お好み焼き 鶴橋風月': {
    note: 'チェーンのため店舗ごとに席の作りが違う。ボックス席の有無やベビーチェアの用意は店舗差があるので、chain全体への設備フラグは外した。お好み焼きを取り分ける前提で使える点は共通。2026-08-19確認。',
  },
  'すみれ（札幌ラーメン）': {
    note: 'ラーメン店で、店舗によりカウンター中心の構成になる。子連れ設備は公式に記載が無く未確認。ベビーカーで入れるかは店舗差があるため断定していない。2026-08-19確認。',
  },
  '世界の山ちゃん': {
    note: '居酒屋チェーンのため、子連れの可否・座敷の有無・時間帯の制限は店舗差が大きい。公式に子連れ設備の記載が無いため未確認のままとする。記事側も「ファミリー歓迎店舗も」という書き方で断定していない。2026-08-19確認。',
  },
  'コストコ 多摩境倉庫 フードコート': {
    note: 'コストコは会員制で、フードコートの利用にも会員証が要る点が他の商業施設と違う（同伴は会員1名につき18歳以上2名まで）。子連れ設備は公式に店舗別の記載が無く未確認。座席が広く取れるのと禁煙である点は共通して使える。2026-08-19確認。',
  },
  'ルクア大阪 バルチカ': {
    note: 'バルチカは立ち飲み・バル業態が中心のフロアで、店舗ごとに席の作りが大きく違う。「ベビーカー入店OK店あり・キッズチェアあり」という書き方のとおり、フロア全体への断定はしていない。子連れ設備は公式に記載が無く未確認。2026-08-19確認。',
  },
  // ── 2026-08-19 屋内施設・大型施設バッチ ──
  '渋谷スクランブルスクエア': {
    nursingRoom: 'yes', diaperChange: 'yes', strollerRental: 'yes',
    note: '施設公式のFAQで、13階に授乳スペース3か所・おむつ替え台4台・休憩スペース・調乳用温水器があることを確認。ベビーカー貸出あり。2026-08-19確認。',
  },
  'GINZA SIX': {
    nursingRoom: 'yes', diaperChange: 'yes', strollerRental: 'yes', kidsSpace: 'yes',
    note: '施設公式のサービス案内で、6階のベビー休憩室に授乳室（女性専用3室＋男女共用1室）、おむつ替えベッド3台、キッズトイレ、調乳用給湯、電子レンジ、キッズプレイスペースがあることを確認。**男女共用の授乳室があるので父親だけでも使える**。ベビーカー貸出は2階インフォメーション。2026-08-19確認。',
  },
  '東京ミッドタウン（六本木）': {
    nursingRoom: 'yes', diaperChange: 'yes', strollerRental: 'yes',
    note: '施設公式「小さなお子様をお連れのお客様へ」で、ガレリア2階のベビールームとB1階の授乳室・おむつ替え台を確認。シンク・電子レンジ・休憩エリアあり、個室以外は男性も利用可。ベビーカー貸出は新生児〜4歳未満（22kg）で、携帯番号と身分証の提示が必要、台数に限りがあり4時間が目安。2026-08-19確認。',
  },
  'MARK IS みなとみらい': {
    nursingRoom: 'yes', diaperChange: 'yes', kidsSpace: 'yes',
    note: '施設公式で、B2階と4階に授乳室（ベビーベッド・調乳用給湯あり）、3階のキッズルーム「おやこの森」にもベビー休憩室があることを確認。おやこの森は0〜2歳と3〜6歳で遊ぶゾーンが分かれており、キッズトイレ・おむつ替えベッド・電子レンジもある。各階に折りたたみ式のおむつ替えシート。2026-08-19確認。',
  },
  'ららテラス武蔵小杉': {
    nursingRoom: 'yes', diaperChange: 'yes',
    note: '施設公式のフロアガイド・サービス案内で授乳室とおむつ交換室の設置を確認。ただし階ごとの正確な位置はPDFのフロアマップ側にあり、今回は階の断定まではしていない。2026-08-19確認。',
  },
  'レゴランド・ディスカバリー・センター東京': {
    note: '施設公式で、対象は主に3〜10歳、営業は平日10:00〜18:00・土日祝10:00〜19:00、混雑時は3時間制と確認。**こどものみ、および大人のみ（16歳以上）の入場はできない**（大人だけ向けの特別イベント開催日を除く）。子連れ前提の施設なので、祖父母だけで下見に行くといった使い方ができない点に注意。2026-08-19確認。',
  },
  'チームラボボーダレス（麻布台ヒルズ）': {
    note: '麻布台ヒルズで営業中と確認（2026年2月9日で移転オープンから2周年、開館2年で324万人以上が来館）。チケットは大人（18歳以上）3,600円。2026年7月8日〜10月8日は特別展「宇宙の非対称性について」を開催予定。※お台場から移転した施設なので、古い情報を参照しないよう注意。2026-08-19確認。',
  },
  '岩山パークランド': {
    note: '⚠ **月〜金は休園で土日のみ営業**（春休み・GW・夏休み期間は無休）。開園は3月中旬〜11月下旬の9:30〜17:00。入園料は大人400円・子ども200円・シニア（65歳以上）200円で、乗り物代は別。平日に行くと閉まっているので、盛岡まで足を運ぶ前に曜日の確認が要る。2026-08-19確認。',
  },
  '東京スカイツリー展望デッキ': {
    nursingRoom: 'yes', diaperChange: 'yes',
    note: '営業は平日・土曜10:00〜22:00、日曜9:00〜22:00。**2026年4月1日入場分から変動価格制**になり、「平日/休日」「前売/当日」の区分が廃止され日ごとに料金が変わる（天望デッキ大人1,800〜3,600円、中学生以下900〜1,800円、天望回廊とのセット券3,000〜4,800円）。固定価格を書かないこと（記事側はすでに変動制で記載済み）。ベビーカーは持ち込み可で預かりサービスもあり、天望デッキに授乳室とベビーシート付き多目的トイレがある。2026-08-19確認。',
  },
  'おもちゃ王国（岡山）': {
    note: '10:00〜17:00（16:45まで入園可）、**休園日は火曜**（祝日・GW・春夏冬休み期間は営業）。入園料はおとな（中学生以上）1,000円・こども（2歳以上）800円で、乗り物代は別。平日に行くなら曜日の確認が要る。2026-08-19確認。',
  },
  'ラ チッタデッラ': {
    nursingRoom: 'yes', diaperChange: 'yes',
    note: '営業は11:00〜23:00（店舗により異なる）、**定休日は火曜・水曜**（祝日を除く）。授乳室が1部屋あり、おむつ替え台・調乳用のお湯・シンク・おむつ用ゴミ箱を備える（女性限定スペース）。広場に噴水がある。2026-08-19確認。',
  },
  'マリンワールド海の中道': {
    note: '通常9:30〜17:30。GW（2026年5月2日〜6日）と冬季（12月〜2月）は10:00〜17:00、夏季は9:30〜21:00に延長（2026年は7月18日〜26日の土日祝、8月1日〜23日は毎日、8月29日〜9月23日の土日祝）。休館日は1月第三月曜から4日間。2026-08-19確認。',
  },
  '加茂水族館': {
    note: '⚠ **名称が変わっている。** リニューアルにより現在の正式名称は「東北エプソンアクアリウムかもすい（鶴岡市立加茂水族館）」。2025年11月〜2026年3月はリニューアル改修で臨時休館し、2026年4月にリニューアルオープン、クラゲの展示は100種類に増えた。営業は9:00〜17:00（最終入館16:00）、年中無休。2026-08-19確認。',
  },
  '鳥羽水族館': {
    nursingRoom: 'yes', diaperChange: 'yes', strollerRental: 'yes',
    note: '**年中無休**、9:30〜17:00（最終入館16:00）。繁忙期（GW 5/2〜5/6、夏季 8/1〜8/28、シルバーウィーク 9/19〜9/23）は9:00〜17:30。授乳室・おむつ替え台があり、**ベビーカー貸出は無料**。2026-08-19確認。',
  },
  '静岡科学館る・く・る': {
    note: '9:30〜17:00（入館は16:30まで）、**休館日は月曜**（祝日の場合は開館し翌日休館）と年末年始（12月29日〜1月3日）。入館料は大人520円・小中学生120円だが、**静岡市内在住・通学の小中学生と未就学児、静岡市内在住の70歳以上は無料**。2026-08-19確認。',
  },
  'あぶくま洞': {
    note: '⚠ **洞内は階段が約300段あり、ベビーカーや車いすでは入れない。** 抱っこ紐で入るか、ベビーカーは入口に置く前提で計画する必要がある。営業時間は季節で変わり、4/1〜6/23と10/1〜11/15と3/7〜3/31が8:30〜17:00、6/24〜9/30が8:30〜17:30、11/16〜3/6が8:30〜16:30（探検コースの受付は終了1時間30分前まで）。料金は大人（高校生以上）1,200円・中学生800円・小学生600円で、**小学生未満は無料**。2026-08-19確認。',
  },
  '日光江戸村': {
    note: '正式名称は「EDO WONDERLAND 日光江戸村」。営業は夏季（3/20〜11/30）9:00〜17:00、冬季（12/1〜3/19）9:30〜16:00。**毎週水曜が定休**（祝日、12/29〜1/5、4/29〜5/5、7/21〜8/31を除く）で、1/16〜1/31はメンテナンス休村。水曜に行く予定なら要確認。2026-08-19確認。',
  },
  'こども創造センター': {
    note: 'いくとぴあ食花内の施設で、**入館無料**、9:00〜17:00。休館日は不定休のため、出発前に公式で確認が要る。陶芸や美術工作などの創作スペース、年齢に合わせて遊べるスペース、親子の交流スペースがある。2026-08-19確認。',
  },
  // キーは重複整理後に残した側の名前（スペースあり）に合わせている
  '岩手県立児童館 いわて子どもの森': {
    note: '**入館無料**、9:00〜17:00。**休館日は火曜**（火曜が祝日の場合は翌日）、年末年始（12/29〜1/3）、ほかに年4回の整備休館がある。一戸町奥中山字西田子1468-2。2026-08-19確認。',
  },
  'マルイファミリー溝口': {
    note: '丸井公式（0101.co.jp）の店舗ページ・サービス案内をあたったが、ベビー休憩室や授乳室のフロア・内容の記載を見つけられず、**設備は未確認のまま**とする。二次情報では8階にベビー休憩室があるとされるが、公式で裏が取れていないため断定しない。2026-08-19確認。',
  },
};
