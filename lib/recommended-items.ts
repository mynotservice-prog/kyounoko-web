...
export const ALL_ITEMS: RecommendedItem[] = [
  ...
  },
  {
    ...
    categories: ['zoo', 'park', 'amusement', 'farm', 'aquarium', 'museum', 'seasonal', 'indoor', 'harvest'],
    priority: 9,
  },
  {
    label: 'ヒップシート・抱っこ紐',
  ...
  },
  {
    ...
    categories: ['zoo', 'park', 'amusement', 'farm', 'seasonal', 'harvest'],
    places: ['outdoor', 'mixed'],
    priority: 8,
  },
  {
    ...
    categories: ['park', 'farm', 'zoo', 'seasonal', 'harvest'],
    places: ['outdoor', 'mixed'],
    priority: 7,
  },
  {
    ...
    categories: ['park', 'zoo', 'farm', 'amusement', 'harvest'],
    places: ['outdoor', 'mixed'],
    priority: 6,
  },
  ...
  // ===== 全シーン共通 =====
  {
    ...
    categories: ['zoo', 'park', 'amusement', 'farm', 'aquarium', 'museum', 'seasonal', 'indoor', 'restaurant', 'harvest'],
    priority: 5,
  },
  {
  ...
  },
  {
    ...
    categories: ['zoo', 'park', 'amusement', 'farm', 'aquarium', 'seasonal', 'harvest'],
    ages: ['0-1', '2-3'],
    priority: 5,
  },
