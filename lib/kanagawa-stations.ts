...
export const KANAGAWA_STATIONS: KanagawaStation[] = [
  ...
  // --- 子連れスポットの最寄駅（プラン生成の距離アンカー用に追加） ---
  {
    ...
    scale: 'minor',
    familyFriendly: true,
    description: '「こどもの国」の専用駅。広大な自然遊び場・牧場・季節プール/スケート場がある定番。',
  },
  {
    slug: 'yokohama-nakayama',
    name: '中山',
    kana: 'なかやま',
    city: 'yokohama',
    area: '緑区',
    lines: ['JR横浜線', '横浜市営地下鉄グリーンライン'],
    scale: 'minor',
    familyFriendly: true,
    description: 'よこはま動物園ズーラシア・四季の森公園へのバス拠点。緑区の自然・動物スポットの玄関口。',
  },
  {
    slug: 'hakkeijima',
    name: '八景島',
    ...
    scale: 'minor',
    familyFriendly: true,
    description: '横浜・八景島シーパラダイスの最寄り。水族館とアトラクションが一体の海上レジャー島。',
  },
  {
    slug: 'yokodai',
    name: '洋光台',
    ...
    scale: 'minor',
    familyFriendly: true,
    description: 'はまぎん こども宇宙科学館の最寄り。体験型の科学展示が充実した磯子区の住宅地。',
  },
  {
    slug: 'tsujido',
    name: '辻堂',
    ...
    scale: 'major',
    familyFriendly: true,
    description: 'テラスモール湘南直結。辻堂海浜公園（ジャンボプール・交通公園）も徒歩圏の湘南ファミリー拠点。',
  },
  {
    slug: 'katase-enoshima',
    name: '片瀬江ノ島',
    kana: 'かたせえのしま',
    city: 'fujisawa',
    area: '江の島',
    ...
    scale: 'minor',
    familyFriendly: true,
    description: '新江ノ島水族館・片瀬東浜海岸の最寄り。竜宮城を模した駅舎で江の島観光の玄関口。',
  },
  {
    slug: 'mukogaoka-yuen',
    name: '向ヶ丘遊園',
    ...
    scale: 'minor',
    familyFriendly: true,
    description: '日本民家園・生田緑地（藤子・F・不二雄ミュージアム方面）の玄関口。川崎市多摩区の自然拠点。',
  },
];
