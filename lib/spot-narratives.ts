...
const ENJOY_BY_AGE: Record<SpotCategory, Record<string, string>> = {
  ...
  // 収穫体験のテンプレート（2026-09 に seasonal から分離。文面は旧 seasonal のまま）
  harvest: {
  ...
  seasonal: {
    '0-1': '人混みと段差が多い場所もあるので、抱っこ紐があると安心。見どころを1〜2か所に絞って短時間で回るのが◎。',
    '2-3': '歩く距離が伸びやすいので、休憩できる場所を先に確認しておくと安心。食べ歩きやおみやげ選びなど「自分で選ぶ」楽しみを入れると満足度が上がります。',
    '4-6': '事前に写真や地図で「何を見に行くか」を話しておくと、現地での興味が続きます。',
  },
  restaurant: {
