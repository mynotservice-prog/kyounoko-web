...
const BASE_EVENTS: EventEntry[] = [
  ...
  {
    slug: 'ehime-kodomonoshiro-daidougei-2026',
    title: 'えひめこどもの城 シルバーウィーク！こしろ大道芸フェスティバル',
    lede: '広い園内でマジックやジャグリング、「こびとのサーカス」のショーを無料で見られる1日だけのイベント。大道芸人が園内を歩き回るので、遊具で遊びながらショーに出会えるのが子連れには気楽です。',
    category: 'show',
    startDate: '2026-09-20', endDate: '2026-09-20',
    venue: 'えひめこどもの城', area: 'ehime', city: '松山市',
    ageLabel: '0歳〜', price: '無料',
    officialUrl: 'https://www.i-kodomo.jp/event/detail/2026/09/007.html',
    tags: ['大道芸', '無料', '屋外', 'シルバーウィーク'],
    note: '公式イベントページに「2026年9月20日（日）」と掲載（2026-09-14確認）。10:30〜15:00頃（演目ごと）。小雨決行・雨天中止で、荒天時は屋内の多目的ホールで実施。',
  },
  {
