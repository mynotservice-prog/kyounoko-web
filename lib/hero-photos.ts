...
const POOL: Record<PhotoCat, string[]> = {
  ...
  'kid-study': [...scenes('book', 7), ...scenes('home-play', 8), ...scenes('lesson', 5), ...scenes('print-gakushu', 1), ...scenes('kyouzai', 1)],
  'kid-craft': [...scenes('craft', 4), ...scenes('home-play', 12), ...scenes('toy', 3)],
  'family-dinner': [...scenes('meal', 41), ...scenes('ramen-kodomo', 1)],
  'home-cozy': [...scenes('home-play', 25), ...scenes('indoor-play', 6), ...scenes('meal', 12), ...scenes('sleep', 5)],
  'food-japan': [...scenes('bento', 5), ...scenes('meal', 30), ...scenes('cooking', 4), ...scenes('tkg', 1)],
  'food-kitchen': [...scenes('cooking', 4), ...scenes('meal', 20)],
  'food-fruit': [...scenes('meal', 25), ...scenes('baby-food', 5), ...scenes('lemon', 1)],
  'food-sweet': [...scenes('meal', 15), ...scenes('cooking', 4), ...scenes('aisu', 1), ...scenes('kakigori', 1)],
  ...
  stroller: [...scenes('stroller', 7), ...scenes('outing-general', 8), ...scenes('strollerok', 3), ...scenes('babycar-hikaku', 1), ...scenes('dakkohimo', 1)],
