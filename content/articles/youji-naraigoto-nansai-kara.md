...
hero: /img/scenes/lesson-09.webp
area: all
quickInfo:
  ageRanges:
    - 2-3
...
- [幼児通信教材3社比較](/article/tsuushin-kyouzai-hikaku)
...
A. **1つあたり月6,000〜12,000円**が目安、発表会費・教材費・ユニフォーム代で年2〜5万円上乗せ。世帯平均は**月1.5〜2.5万円**（ベネッセ調査）。2つ以上なら年30万円前後を見込むのが現実的。

### Q. 送迎できない時の対処は？

A. **(1)送迎サービス付きスクール（月3,000〜5,000円）(2)ファミサポ/シッター（1時間1,000〜2,000円）(3)祖父母協力**の3択。自宅完結なら**オンライン英会話やワンダーボックス**という手も。

### Q. 「向いてない」と感じたら？

A. **まず3ヶ月は様子見**。最初の1〜2ヶ月は誰でもぎこちないもの。3ヶ月経って合わないなら**同じジャンルの他教室の体験**を1回受けてから判断を。

### Q. 複数習わせていい？

A. **2つまでなら3〜4歳でも多くの家庭が実践**。**運動1+学習1 or 運動1+表現1**のように領域を分けるのが続きやすい。3つ以上は年長（5〜6歳）以降が無難。

### Q. お金がないと習い事はできない？

A. **自治体の無料・低額幼児教室（月1,000〜3,000円）で十分代替可能**。通信教育（こどもちゃれんじ・Z会幼児）は月2,000〜3,000円で体系的にカバー。「習い事に通わない選択」も全く問題なし。
