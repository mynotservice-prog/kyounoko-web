...
A. **補助として1日100mlまでならOK**。食物繊維が少なく噛む練習にもならないので常用は避けましょう（カゴメ野菜生活・伊藤園1日分の野菜など）。

### Q. 隠し味で野菜を刻んで混ぜるのは？

A. **短期の栄養補給としては有効ですが、「食べられた」成功体験にはならない**ので、見える形でも並行して出しましょう。ハンバーグ・餃子・ミートソースが定番。

### Q. サプリで栄養を補ってもいい？

A. **3歳で日常的に野菜を全く食べない場合のみ、小児科医に相談**を。市販の子ども用マルチビタミン（わかさ生活・ディアナチュラ等）は補助程度に留めます。

### Q. 保育園では食べるのに家では食べない

A. **集団心理で食べる典型パターン**です。担任に園の盛り付けを聞き、家で「保育園と同じお皿・量」を再現すると食べることがあります。

### Q. いつまで続ければ食べるようになる？

A. **平均4〜5歳で約8割の子が克服**します。5歳半を超えても全拒否が続く場合は、偏食外来のある小児科への相談を検討してください。
