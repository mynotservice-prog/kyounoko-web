...
metaDescription: 0〜6歳の絵本読み聞かせのコツを年齢別に解説。聞かない・飽きる時の5つの工夫、年齢別おすすめ絵本リスト、仕掛け絵本から長編まで実践的に。準備物の100均/Amazon別開示も完備した保存版。
category: today-nani
categoryName: 今日何する？
...
quickInfo:
  ...
  durationMin: 10
  budget: "low"
lede: 実は読み聞かせ、年齢ごとに最適解が違う。0-1歳の仕掛け絵本、2-3歳のストーリー、4-6歳の対話型読みまで、聞かない時の工夫5つと年齢別おすすめ絵本を保存版で。1日10分・寝る前ルーティンの鉄板。
speakableSummary: 絵本の読み聞かせは年齢別に最適解が異なるとされ、0-1歳は仕掛け絵本・コントラスト絵本（だるまさんが・しましまぐるぐる等）、2-3歳は短いストーリー（きんぎょがにげた・はらぺこあおむし）、4-6歳は対話型・長編（ぐりとぐら・スイミー）が定番。1日10分・寝る前ルーティンが続けやすく、所持冊数の目安は0-1歳10〜15冊・4-6歳30〜50冊。図書館併用で十分とされる経験則。
---
