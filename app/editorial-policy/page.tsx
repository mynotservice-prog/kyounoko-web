    ...
    <>
      ...
      <div className="container-article">
        ...
        <article className="prose">
          ...
          <h3>5-3. 記事区分の定義（アフィリエイト／タイアップ／無償提供）</h3>
          <p>
            外部の事業者・施設と利害関係のある記事は、景品表示法のステルスマーケティング規制（2023年10月施行）の運用基準に沿って、次の3区分で管理します。
          </p>
          <ul>
            <li>
              <strong>アフィリエイト</strong>：記事内に成果報酬型の広告リンクを含むもの。
              記事の企画・執筆はきょうのこが自主的に行い、リンク先の事業者は内容に関与しません。
            </li>
            <li>
              <strong>タイアップ（有償PR）</strong>：事業者から金銭・物品・サービス等の対価を受けて制作する記事。
              掲載自体や内容に事業者の依頼・意向が反映されるため、景品表示法上の「事業者の表示」＝広告として扱います。
            </li>
            <li>
              <strong>無償提供（商品・写真提供のみ）</strong>：金銭の受領はなく、公式写真や商品などの提供のみを受けるもの。
              掲載するかどうかの判断と記事の内容は、きょうのこが自主的に決定し、提供元は表現に関与しません。
              この条件を満たさない場合（内容の指定・修正指示・掲載の見返り条件がある場合）は、無償であってもタイアップとして扱います。
            </li>
          </ul>
          <h3>5-4. 各区分のバッジ表示</h3>
          <p>
            該当する記事には、本文冒頭の視認しやすい位置に次のバッジを表示します。
            記事末尾のみの表示や、周囲に埋もれて認識できない表示は行いません。
          </p>
          <ul>
            <li><strong>アフィリエイト</strong>：「PR」ラベル＋「一部リンクから収益を得ています（アフィリエイト）。」</li>
            <li><strong>タイアップ（有償PR）</strong>：「PR」ラベル＋「この記事は◯◯（提供元名）から対価を受けて制作したタイアップ記事（広告）です。」</li>
            <li><strong>無償提供</strong>：「提供」ラベル＋「本記事は◯◯（提供元名）より写真（商品）の無償提供を受けています。金銭は受け取っておらず、内容は運営者が独自に構成しています。」</li>
          </ul>
          <h3>5-5. 提供元名の明記</h3>
          <ul>
            <li><strong>タイアップ</strong>：提供元の事業者名（施設名・ブランド名）を冒頭バッジ内に必ず明記します。「協力」のみの曖昧な表記や、社名を伏せた表示は行いません。</li>
            <li><strong>無償提供</strong>：提供元名を冒頭バッジに明記し、提供を受けた写真には「写真提供：◯◯」のクレジットを付けます。</li>
            <li><strong>アフィリエイト</strong>：リンクごとの広告主名は記事内に表示せず、利用しているアフィリエイトプログラム（5-1参照）を本ページで開示します。</li>
          </ul>
          <p>
            いずれの区分でも、評価や所感の記述が対価・提供の有無に左右されることはありません。
